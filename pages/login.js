  ...
  return (
    <div>
      ...
      <div className="login-container">
        ...
        <Alert
          variant="success"
          // Besides "success," Bootstrap alerts also support the following variants:
        ...
        <form data-tag="submit-login-form" onSubmit={handleLogin}>
          <input
            data-tag="input-email"
            type="text"
            id="email"
            placeholder="email"
            onChange={handleEmailChange}
          />
          <label data-tag="label-email" htmlFor="email">
            email
          </label>
          <input
            data-tag="input-password"
            type="password"
            id="password"
            placeholder="password"
            onChange={handlePasswordChange}
          />
          <label data-tag="label-password" htmlFor="password">
            password
          </label>
          <button data-tag="login-button" type="submit">
            Login
          </button>
        </form>
        <button data-tag="logout-button" onClick={handleLogout} type="submit">
          Logout
        </button>
      </div>
    </div>
