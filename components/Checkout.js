...
function Checkout() {
  ...
  return (
    <div>
        ...
        <input type="text" id="street" placeholder="street address" onChange={handleStreetChange}/>
        <label htmlFor="street" >street address</label>
        <input type="text" id="apartment" placeholder="apartment" onChange={handleApartmentChange}/>
